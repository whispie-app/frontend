function App() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-200 via-white to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="bg-white dark:bg-gray-700 rounded-xl shadow-2xl p-50 flex flex-col items-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 mb-4 text-center"></p>
